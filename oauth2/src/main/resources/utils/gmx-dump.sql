...
INSERT INTO `oauth_client_details` VALUES ('gmax','2n3055s','inbound,outbound','read,write','password,refresh_token',NULL,'ROLE_CLIENT',3600,7200,NULL,NULL);
...
CREATE TABLE `roles` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_roles_username` (`username`)
...
INSERT INTO `roles` VALUES (1,'admin','ROLE_ADMIN'),(2,'admin','ROLE_USER'),(3,'user','ROLE_USER'),(4,'marius','ROLE_DEVELOPER');
...
INSERT INTO `users` VALUES ('admin','admin',1),('marius','gligor',1),('user','user',0);
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'gmax'
--
...
-- Dump completed on 2017-01-06 22:07:34
